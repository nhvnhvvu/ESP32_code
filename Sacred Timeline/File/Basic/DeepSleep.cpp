...
#define TIME_TO_SLEEP  3        //Thời gian thức dậy
...
void setup(){
  ...
  // băt đầu vào chế độ ngủ (các hàm ở dưới sẽ ko đc thực thi)
  esp_deep_sleep_start(); // sau khi tỉnh dậy sẽ chạy lại từ hàm setup và phải thiết lập đánh thức again
}
